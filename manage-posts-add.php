...
<body>
  <div class="container mx-auto my-5" style="max-width: 700px;">
      ...
      <form id="addScheduleForm" method="POST">
        <div class="mb-3">
          ...
          <select class="form-control text-white" id="program_id" name="program_id"
                  style="background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.1);" required>
        ...
        <div class="mb-3">
          ...
          <select class="form-control text-white" id="host_id" name="host_id"
                  style="background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.1);" required>
        ...
        <div class="mb-3">
          ...
          <input type="date" class="form-control text-white" id="air_date" name="air_date"
                 style="background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.1);" required/>
        </div>
        ...
        <div class="row">
          <div class="col-6 mb-3">
            ...
            <input type="time" class="form-control text-white" id="start_time" name="start_time"
                   style="background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.1);" required/>
          </div>
          <div class="col-6 mb-3">
            <label for="end_time" class="form-label">End Time</label>
            <input type="time" class="form-control text-white" id="end_time" name="end_time"
                   style="background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.1);" required/>
          </div>
        </div>

        <div class="text-end mt-3">
          <button type="submit" class="btn btn-accent text-white-custom" style="background-color: var(--accent);">
            Add Schedule
          </button>
        </div>
      </form>
    ...
    <div class="text-center">
      <a href="manage-schedule.php" class="btn btn-outline-info btn-sm mt-2 text-white-custom"
